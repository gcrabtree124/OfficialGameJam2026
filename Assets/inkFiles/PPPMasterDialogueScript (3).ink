...
===INTRO===
 #bg Intro0
Hi Mihal this is a pretrty long sentence 
Hi again !!!!!!! longgggggggggggggggggggggggg lingasdasd
Hi hi hih ihihihihihihihihihihi
*Choice 1
*choice 2 I"m extra longgggggggggg
*choice 3 I"m way toooooooo lonoongngngngngng
 -->intro_wake_up 
= intro_wake_up 
{&"zzz..."|"zzzzz..."|"zzzzzzz..."|->wakeorsleep}#next
+[-]->intro_wake_up
= wakeorsleep
???: "{&Hey kiddo, it's time to wake up.|You really need to wake up...|<i>Seriously</i>, you need to wake up now.}"
+[*Wake Up*]{wakeorsleep < 2 : |???: "Not much of a morning person are you?"}->wakeUp
...
= wakeUpEnd  
# bg Intro1
You open your eyes and lift yourself upright.
    *[*Yawn*]->start
= start
*["Where am I?"]???: "Uh... technically this is your room, but I wouldn't want to stay there if I were you..."
*["How did I get here?"]???: "We don't know... we're not even sure where you are exactly..."
-->who_are_you
= who_are_you
*["Hold on... who's there?"] ???: "A friend. We can get you out of there, but you have to trust us. ->theFirstNeuronTree
=theFirstNeuronTree
*["Who is <b>us</b>?"]->treeSprouts
= treeSprouts
# bg Intro2
!!!!!
...
->WhatDoYouDo
=DownTheRabbitHole
?????: "{inspectitfirst > 0 :Brace yourself little one!|Rather a bold little one aren't you? Hang on!}"->Intro4
=Intro4
# bg Intro4
*[-#next]
->Scene2
    ...
    ???: "...you need to...... by yourself now."
        **["I can't understand you, it's all...warbled."]
        ?????: "...not much time.....to help..."
            ***["Help who?"]
                ???: "...hear me....there kiddo."<br>????: "..it's up to you....child.......ust you."<br>?????: "Listen...carefully....little one.......you must..."
                ****["What's going on!?!"]
                ****["What are you saying!?!"]
            - ->Scene2Frame2
    =Scene2Frame2
...
*[<i>Oh things are <b>definitely</b> going to get worse]{raise(fear)}
- ->Scene2Frame16
=Scene2Frame16
#bg Portal3
...
#bg Portal1
* ["Wooooaaaahhh!"]
    **[<em>It's happening again?!?] #black #anim Memory
